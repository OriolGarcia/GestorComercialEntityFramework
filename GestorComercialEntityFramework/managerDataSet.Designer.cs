...
namespace GestorComercialEntityFramework.managerDataSetTableAdapters {
    ...
    public partial class customersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[2].CommandText = @"SELECT        EMAIL, FAX, ID, NAME, POSTAL_ADRESS, POSTAL_CODE, PROVINCE, SURNAME_1, SURNAME_2, TELEPHONE, TOWN
FROM            customers
WHERE        (LENGTH(@NAME) <1 OR NAME LIKE @NAMESEARCH) AND ((LENGTH(@SURNAME)<1 OR SURNAME_1 LIKE @SURNAMESEARCH OR SURNAME_2 LIKE @SURNAMESEARCH) ) AND (LENGTH(@TOWN) <1 OR TOWN LIKE @TOWNSEARCH)";
            ...
            this._commandCollection[2].Parameters.Add(param);
            param = new global::MySql.Data.MySqlClient.MySqlParameter();
            param.ParameterName = "@TOWNSEARCH";
            param.DbType = global::System.Data.DbType.String;
            param.MySqlDbType = global::MySql.Data.MySqlClient.MySqlDbType.TinyText;
            param.Size = 255;
            param.IsNullable = true;
        ...
        public virtual int FillByFilter(managerDataSet.customersDataTable dataTable, string NAME, string NAMESEARCH, string SURNAME, string SURNAMESEARCH, string TOWN, string TOWNSEARCH) {
            ...
            if ((TOWN == null)) {
                ...
                this.Adapter.SelectCommand.Parameters[4].Value = ((string)(TOWN));
            }
            if ((TOWNSEARCH == null)) {
                throw new global::System.ArgumentNullException("TOWNSEARCH");
            }
            else {
                this.Adapter.SelectCommand.Parameters[5].Value = ((string)(TOWNSEARCH));
            }
            if ((this.ClearBeforeFill == true)) {
                dataTable.Clear();
            }
        ...
        public virtual managerDataSet.customersDataTable GetDataByFilter(string NAME, string NAMESEARCH, string SURNAME, string SURNAMESEARCH, string TOWN, string TOWNSEARCH) {
            this.Adapter.SelectCommand = this.CommandCollection[2];
            if ((NAME == null)) {
                throw new global::System.ArgumentNullException("NAME");
            }
